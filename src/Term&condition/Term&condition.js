...
function Termcondition() {
    ...
    return (
        <>
        <button className=' mt-2  mx-2 px-3' style={{  cursor: "pointer",borderRadius:"6px", background:"black",color:"white" }} onClick={() => navigate("/signup")}>Back </button>
            <div className='text-center '><strong style={{fontSize:"35px", color:"red"}}>Term & condition</strong></div>
            <div className='p-3 m-5'>
                <div className='m-2'><strong style={{fontSize:"20px", }}>E-Commerce Terms of Use</strong></div>
                <ul>
                    <li> This document is an electronic record in terms of Information Technology Act, 2000 and rules there under as applicable and the amended provisions pertaining to electronic records in various statutes as amended by the Information Technology Act, 2000. This electronic record is generated by a computer system and does not require any physical or digital signatures.
                    </li><li>
                        This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name [www.E-Commerce.com][www.flipkart.com] (“Website”), including the related mobile site and mobile application (hereinafter referred to as “Platform”)
                    </li><li >
                        The Platform is owned by E-Commerce Internet Private Limited a company incorporated under the Companies Act, 1956 with its registered office at Buildings Alyssa, Begonia & Clover, Embassy Tech Village, Outer Ring Road, Devarabeesanahalli Village, Bengaluru – 560103, Karnataka, India and its branch offices at 2nd Floor, Block F(Flora), Embassy Tech Village, Outer Ring Road, Devarabeesanahalli Village, Bengaluru - 560103, Karnataka, India and; 447 / C, 12th Main, 4th Block, Koramangala, Bengaluru - 560034, Karnataka, India(hereinafter referred to as "Flipkart").
                    </li ><li >
                        Your use of the Platform and services and tools are governed by the following terms and conditions("Terms of Use") as applicable to the Platform including the applicable policies which are incorporated herein by way of reference.If You transact on the Platform, You shall be subject to the policies that are applicable to the Platform for such transaction.By mere use of the Platform, You shall be contracting withE-Commerce Internet Private Limited and these terms and conditions including the policies constitute Your binding obligations, with Flipkart.
                    </li ><li >
                        For the purpose of these Terms of Use, wherever the context so requires "You" or "User" shall mean any natural or legal person who has agreed to become a buyer on the Platform by providing Registration Data while registering on the Platform as Registered User using the computer systems.Flipkart allows the User to surf the Platform or making purchases without registering on the Platform.The term "We", "Us", "Our" shall mean E-Commerce Internet Private Limited.
                    </li ><li >
                ...
                <div className='mt-3 mb-3'><strong style={{fontSize:"20px", }}>Membership Eligibility</strong></div>
                ...
                <div className='mt-3 mb-3'><strong style={{fontSize:"20px", }}>Your Account and Registration Obligations</strong></div>
                    ...
                    <div className='mt-3 mb-3'><strong style={{fontSize:"20px", }}> Communications</strong></div>
                    ...
                    <div className='mt-3 mb-3'><strong style={{fontSize:"20px", }}>Platform for Transaction and Communication</strong></div>
